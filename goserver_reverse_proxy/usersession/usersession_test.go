...
func TestGetUser(t *testing.T){
	...
	usertype, userid := GetUserByCookieIP(r_ression_id,ip,Getwd,fileReaderA);
	...
	usertype, userid = GetUserByCookieIP(r_ression_id,ip,Getwd,fileReaderB);
	...
	usertype, userid = GetUserByCookieIP(r_ression_id,ip,Getwd,fileReaderC);
	...
	usertype, userid = GetUserByCookieIP(r_ression_id,ip,Getwd,fileReaderD);
	...
	usertype, userid = GetUserByCookieIP(r_ression_id,ip,Getwd,fileReaderE);
