...
func TestLimits(t *testing.T){
	...
	a1,a2 := GetLimitersForPathAndUserType("/experts/general",s.UserTypeUnverified)
	b1,b2 := GetLimitersForPathAndUserType("/experts/general",s.UserTypeCaptchad)
	c1,c2 := GetLimitersForPathAndUserType("/experts/general",s.UserTypeGithub)
	d1,d2 := GetLimitersForPathAndUserType("/experts/general",s.UserTypeGoogle)
	e1,e2 := GetLimitersForPathAndUserType("/experts/general","whatever")

	f1,f2 := GetLimitersForPathAndUserType("/recieved_images/a.jpg",s.UserTypeUnverified)
	g1,g2 := GetLimitersForPathAndUserType("/recieved_images/a.jpg",s.UserTypeCaptchad)
	h1,h2 := GetLimitersForPathAndUserType("/recieved_images/a.jpg",s.UserTypeGithub)
	i1,i2 := GetLimitersForPathAndUserType("/recieved_images/a.jpg",s.UserTypeGoogle)
